...
#define PAYLOAD_SIZE 2048  // Payload size in bytes
...
int main(int argc, char* argv[]) {
    ...
    printf("MADE BY @CRACKWARS_DANZER %s:%d for %d seconds with %d threads...\n",
    ...
    printf("FUCKED ATTACK @CRACKWARS_DANZER HOST IP %s on port %d for %d seconds\n",
